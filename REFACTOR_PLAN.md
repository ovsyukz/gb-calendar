...
| F12 | Admin sees participant list, can remove a sign-up | keep — and *fixed*, see #9 |
...
controls *what is drawn*, never *what is allowed*. This matters more now than
...
is harmless), and the CSS. If a *logic* file starts pushing 100 lines, that is
